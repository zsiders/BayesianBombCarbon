...
model {
	...
	//local calc
	{
		vector[Nref] C14_hat; //predicted reference
		...
		C14_hat = a0*to_vector(BY_ref) + to_vector(a*B); //predict C14 of reference
		...
		//Likelihood
		target += normal_lpdf(C14_ref|C14_hat, sigma_ref)*wt; //reference
